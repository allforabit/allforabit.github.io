...
#+NAME:   Add device
[[./img/place.png]]
#+CAPTION: Move the sliders of the main view to create your basic arrangement. Each slider amount represents the a single bar. The values here are global across your project and is what will link events and changes across the project.
